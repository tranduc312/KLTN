          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Thay đổi thông tin Giao Hàng</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="admin/editgiaohang" class="form-horizontal form-label-left">
						
                     
                      <span class="section">Thông Tin Giao Hàng </span>
                      <div>
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          name="ID_GH"  required="required" type="text" value="${giaohang.ID_GH}" readonly>
                        </div>
                      </div>
                     <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Nhân Viên Giao 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="optional form-control col-md-7 col-xs-12" name="ID_DH" >
								...
								<c:if test="${donhang.tinh_Trang==2}">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" >Thời Gian Giao 
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12"  
                          name="Ngay_Giao"  required="required" type="text" value="${giaohang.ngay_Giao}">
                        </div>
                      </div>

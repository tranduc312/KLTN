          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Thay đổi thông tin User User</h3>
              </div>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form method="post" action="edituser" class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="Mat_Khau"  class="form-control col-md-7 col-xs-12" 
                          required="required" value="${user.mat_Khau}">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input  type="text"  name="Dia_Chi"  class="optional form-control col-md-7 col-xs-12"
                          value="${user.dia_Chi}">
                        </div>
                      </div>

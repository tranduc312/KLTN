          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Danh Sách Nhân Viên <small></small></h2>
                    <div class="nav navbar-right panel_toolbox">
	                  	<button class="btn btn-success btn-lg"><a href="adduser"><i class="fa fa-plus-square"> Thêm Mới</i></a>
	                  	</button>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
							...
							<%
								ArrayList<Kho> listkho = (ArrayList) request.getAttribute("listkho");
								ArrayList<User> listuser = (ArrayList) request.getAttribute("listuser");
								ArrayList<Vai_Tro> listvaitro = (ArrayList) request.getAttribute("listvaitro");
								String tenkho="";
								String tenvaitro ="";
								for(Kho kho : listkho){
									for(User user : listuser){
										for(Vai_Tro vaitro : listvaitro){
											if(user.getID_Kho()==kho.getID_kho()){
												tenkho = kho.getTen_Kho();
												if(user.getID_Role()==vaitro.getID_Role()){
													tenvaitro = vaitro.getVai_Tro();

...
var validator = (function($){
    ...
    */
    message = {
		invalid         : 'Nhập sai rồi 3!',
        checked         : 'must be checked',
        empty           : 'Vui lòng nhập thông tin',
        min             : 'Nhập nhiều hơn?',
        max             : 'Nhập nhiều quá vậy?',
        number_min      : 'ngắn quá',
        number_max      : 'dài quá',
        url             : 'sai URL rồi 3!',
        number          : 'Nhập số vào fen',
        email           : 'Nhập đúng Email vào fen',
        email_repeat    : 'Nhập lại Email sai',
        password_repeat : 'Nhập lại mật khẩu sai',
        repeat          : 'không chính xác',
        complete        : 'Nhập đầy đủ vào?',
        select          : 'Chọn 1 tùy chọn'
    };
    ...
    */
    function checkAll( $form ){
        ...
        var that = this,
            ...
            fieldsToCheck = $form.find(':input').filter('[required=required], .required').not('[disabled=disabled]');
        //ham sida khong cho submit

...
/**
 * Servlet implementation class ListGiaoHang
 */
@WebServlet("/admin/listgiaohang")
public class AdminListGiaoHang extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminListGiaoHang() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Giao_Hang> listgiaohang = giaohangBO.getListGH();
		request.setAttribute("listgiaohang", listgiaohang);
		...
		//chuyen trang
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/WEB-INF/admin/listgiaohang.jsp");
